<div id="mse2_mfilter" class="msearch2">
    ...
    <div class="row category__content ">
        <div class="col-12 col-lg-3 order-3 order-lg-2 flex-sm column aside__left">
            <div class="row">
                <div class="aside__left-menu col-12 col-sm-6 col-md-6 col-lg-12 mb-4">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="resource-menu-content" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <div class="btn-group-vertical w-100">{$wrapper}</div>
                                </div>',
                                'tplInner' => '@INLINE
                                <ul class="dropdown-menu">{$wrapper}</ul>
                                ',
                                'tpl' => '@INLINE
                                {if "level1" | in : $classnames}
                                <div class="btn-group dropend w-100 {$classnames}" role="group"
                                    aria-label="Left menu item">
                                    <a type="button" class="btn btn-link lh-lg" href="{$link}"
                                        style="border-right: 1px solid #ececec;" {$attributes}>{$menutitle
                                        ?:
                                        $pagetitle}</a>
                                </div>
                                {elseif "level2" | in : $classnames}
                                <div class="col-3 dropdown-item d-flex align-items-center">
                                    <div class="flex-shrink-0 ratio ratio-1x1" style="width: 50px;height: 50px;">
                                        <a href="[[+link]]" class="d-block">
                                            [[getPageAssets? &page_id=`[[+id]]` &limit=`1` &is_image=`1`
                                            &innerTpl=`category.assman` &outerTpl=`category.assman.outer`]]
                                        </a>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <a href="[[+link]]" [[+attributes]]>{$menutitle ?: $pagetitle}</a>
                                    </div>
                                </div>
                                {/if}
                                ',
                                ...
                                <div class="btn-group dropend w-100 {$classnames}" role="group"
                                    aria-label="Left menu item">
                                    <a type="button" class="btn btn-link lh-lg" href="{$link}" {$attributes}>{$menutitle
                                        ?:
                                        $pagetitle}</a>
                                    <button type="button" class="btn-caret btn dropdown-toggle dropdown-toggle-split "
            ...
            <div class="aside__left-banner col-12 col-sm-6 col-md-6 col-lg-12 mb-4">
                <div class="banner">
            ...
            <div class="aside__left-info-button-group col-12 col-sm-6 col-md-6 col-lg-12 mb-4">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-12 mb-5">
        ...
        <div class="col-12 col-lg-9 order-2 order-lg-3 aside__content">
